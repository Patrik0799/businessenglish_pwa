 ...
 * @changes
 * version 2.4.0 (18.05.2022):
 * - added HTML class for own messages
 * version 2.3.2 (26.07.2021):
 * - uses ccmjs v26.4.4 as default
 * version 2.3.1 (19.07.2021):
...
//    "user": [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.7.0.js" ]
    ...
    Instance: function () {
      ...
      this.refresh = async message => {
        ...
        message.own = this.user && this.user.isLoggedIn() && this.user.getValue().key === message.user ? ' own' : '';
