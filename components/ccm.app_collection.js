...
//    "logger": [ "ccm.instance", "https://ccmjs.github.io/akless-components/log/versions/ccm.log-5.0.1.min.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/log/resources/configs.min.js", "greedy" ] ],
      "routing": [ "ccm.instance", "./components/ccm.routing.js" ],
      "sections": [],
//    "title": "",
//    "user": [ "ccm.start", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.7.2.min.js" ]
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        this.html.render( this.html.main( this, onClick, navBars ), this.element );
        ...
        if ( this.lang ) {
          this.lang.translate();
          !this.lang.getContext() && $.append( this.element.querySelector( '#nav' ), this.lang.root );
        }

        // render user login/logout button
        this.user && $.append( this.element.querySelector( '#nav' ), this.user.root );
      ...
      const navBars = () => {
        this.element.querySelector( '.bars' ).classList.toggle( "change" );
        const elem = this.element.querySelector( "#myLinks" );
