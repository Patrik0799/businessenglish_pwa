...
//    "hash": [ "ccm.load", "https://ccmjs.github.io/akless-components/modules/md5.mjs" ],
      ...
      "html": [ "ccm.get", "./templates/templates_login.js", "html" ],
//    "logged_in": true,
      ...
      this.logout = async not => {
        ...
        switch ( my.realm ) {
          ...
          case 'lea':
            ...
            break;
          default:
            this.url && await this.ccm.load( { url: this.url, method: 'POST', params: { realm: my.realm, token: data.token } } );
            break;
        }
