...
( () => {
  ...
  //  "time": 60,
  //  "user": [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.6.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/user/resources/configs.js", "guest" ] ]
    },
    ...
    Instance: function () {
      ...
      this.init = async () => {
        ...
        // fill-in-the-blank text is given via object? => use the value at the 'inner' property
        if ( $.isObject( self.text ) ) self.text = self.text.inner;
